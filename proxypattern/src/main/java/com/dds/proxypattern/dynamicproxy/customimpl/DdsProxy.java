...
public class DdsProxy {
    ...
    private static String generateProxyJavaFile(Class<?>[] interfaces) {
        ...
        stringBuilder.append("package com.dds.proxypattern.dynamicproxy.customimpl;" + LN);
        ...
        for (Method m : methods) {
            ...
            stringBuilder.append("Method m = " + interfaces[0].getName() + ".class.getMethod(\"" + m.getName() + "\",new Class[]{});");
            stringBuilder.append("this.h.invoke(this,m,null);");
